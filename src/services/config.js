export const EULER_ENDPOINTS = {
	...
	optimism: "https://api.goldsky.com/api/public/project_cm4iagnemt1wp01xn4gh1agft/dashboard/subgraphs/euler-v2-optimism/1.0.1",
...
export const useEulerEndpoint = (chain = 'mainnet') => {
	return EULER_ENDPOINTS[chain] || EULER_ENDPOINTS.mainnet
}